...
<!-- <========================================================================================> -->    
      <ul class="sidebar-menu" data-widget="tree">
       <li class="header">Menu Utama</li>
        ...
        <!-- <li><a href="<?php echo site_url('Guru/DataGuru'); ?>"><i class="fa fa-users"></i> <span>Data Guru</span></a></li> -->
     ...
     <?php }elseif ($this->session->userdata('level') == "admin"){?>
       ...
       <li><a href="<?php echo site_url('APembayaran/DataPembayaran'); ?>"><i class="fa fa-money"></i> <span>Data Pembayaran</span></a></li>
     ...
     <?php }else{ ?>
      ...
      <!-- <li><a href="<?php echo site_url('SGuru/DataGuru'); ?>"><i class="fa fa-users"></i> <span>Data Guru</span></a></li> -->
